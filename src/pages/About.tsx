        ...
        <section className="py-16 md:py-24 bg-gradient-soft">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Ми — команда професіоналів та людей, що розуміють виклики життя з проблемами суглобів. 
              Наша мета — створити підтримуючу спільноту, де кожен може знайти допомогу та розуміння.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Ми віримо, що кожна людина заслуговує на життя без болю та обмежень. 
                  Наша організація працює над тим, щоб надати доступ до якісної інформації, 
                  підтримки та професійної допомоги всім, хто стикається з проблемами суглобів.
                </p>
