        ...
        <section className="py-16 md:py-24 bg-gradient-soft">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Ми покращуємо якість життя людей із захворюваннями опорно-рухового апарату шляхом 
              надання доступної інформації, створення освітніх ресурсів, підтримки реабілітації 
