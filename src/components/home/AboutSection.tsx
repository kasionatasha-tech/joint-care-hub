      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Ми — громадська організація, що об'єднує людей з проблемами суглобів. 
            Наша місія полягає в наданні підтримки, освіти та доступу до якісної інформації 
            для покращення життя кожного учасника нашої спільноти.
          </p>
        </div>
        ...
        <div className="bg-gradient-soft rounded-3xl p-8 md:p-12 mb-16 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto">
            Допомогти людям з проблемами суглобів жити повноцінним життям без болю. 
            Ми прагнемо створити найбільшу в Україні спільноту взаємної підтримки, 
            де кожен може отримати кваліфіковану допомогу та поділитися своїм досвідом.
          </p>
        </div>
